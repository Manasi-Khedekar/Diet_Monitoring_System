...
public partial class Diet : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        LabelName.Text = Session["fname"].ToString();
        SqlDataAdapter da;
        DataSet ds;
        ...
        else
        {
            if (type == "Normal" || type == "Under Weight")
            {
                s = "Select Top 2 Item,Protine,Carbo from DietChart where PCat='L' AND CCat='M' AND Type='B' Order By NewID()";
            }
            else
            {
                s = "Select Top 1 Item,Protine,Carbo from DietChart where PCat='H' AND CCat='H' AND Type='B' Order By NewID()";
            }
        }
        ...
        else
        {
            if (type == "Normal" || type == "Under Weight")
            {
                s = "Select Top 4 Item,Protine,Carbo from DietChart where PCat='L' AND CCat='M' AND Type='L' Order By NewID()";
            }
            else
            {
                s = "Select Top 3 Item,Protine,Carbo from DietChart where PCat='H' AND CCat='H' AND Type='L' Order By NewID()";
            }
        }
        da = new SqlDataAdapter(s, con);
        ds = new DataSet();
        ...
        else
        {
            if (type == "Normal" || type == "Under Weight")
            {
                s = "Select Top 2 Item,Protine,Carbo from DietChart where PCat='L' AND CCat='M' AND Type='S' Order By NewID()";
            }
            else
            {
                s = "Select Top 1 Item,Protine,Carbo from DietChart where PCat='H' AND CCat='H' AND Type='S' Order By NewID()";
            }
        }
        da = new SqlDataAdapter(s, con);
        ds = new DataSet();
        ...
        else
        {
            if (type == "Normal" || type == "Under Weight")
            {
                s = "Select Top 2 Item,Protine,Carbo from DietChart where PCat='L' AND CCat='M' AND Type='D' Order By NewID()";
            }
            else
            {
                s = "Select Top 2 Item,Protine,Carbo from DietChart where PCat='H' AND CCat='H' AND Type='D' Order By NewID()";
            }
        }
        da = new SqlDataAdapter(s, con);
        ds = new DataSet();
