...
<asp:Button ID="Button2" runat="server" Height="49px" CssClass="btn btn-warning" style="font-family: gadugi; font-size: large" Width="172px" OnClientClick = "return PrintPanel();" Text="Print Diet Plan" OnClick="Button2_Click" /> <%--         &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Height="49px" style="font-family: gadugi; font-size: large" Width="172px" PostBackUrl="~/PersonalisedPlan.aspx" Text="Request Diet Plan" />--%>
            <br />
        <br />
        <br />
    </div>
