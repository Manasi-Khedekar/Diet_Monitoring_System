...
<asp:Content ID="body" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div>
        ...
        <asp:Label ID="Label2" runat="server" Text=" Breakfast  :-&nbsp;&nbsp;" CssClass="auto-style2"></asp:Label>
                ...
                <td align="left">
        <asp:DropDownList ID="DropDownList1" runat="server" Width="215px" CssClass="form-control">
        ...
        <asp:Label ID="Label3" runat="server" Text="Lunch  :-&nbsp;&nbsp;" CssClass="auto-style2"></asp:Label>
                ...
                <td align="left">
        <asp:DropDownList ID="DropDownList2" runat="server"  Width="215px" CssClass="form-control">
        ...
        <asp:Label ID="Label4" runat="server" Text="Snacks  :-&nbsp;&nbsp;" CssClass="auto-style2"></asp:Label>
                ...
                <td align="left">
        <asp:DropDownList ID="DropDownList3" runat="server"  Width="215px" CssClass="form-control">
        ...
        <asp:Label ID="Label5" runat="server" Text="Dinner  :-&nbsp;&nbsp;" CssClass="auto-style2"></asp:Label>
                ...
                <td align="left">
        <asp:DropDownList ID="DropDownList4" runat="server"  Width="215px" CssClass="form-control">
...
&nbsp; 
        <asp:Button ID="Button1" runat="server" CssClass="btn btn-warning" OnClick="Button1_Click" Text="Proceed" />
