...
&nbsp;<asp:Label ID="Label14" runat="server" Text="BMI Calculator" Font-Size="XX-Large" ForeColor="#795B3C" style="color: #996633; font-family: gadugi;"></asp:Label>
       ...
       <div class="col-md-12">
            ...
            <br />
            <div class="row">
            <div class="col-md-5 text-right"> <asp:Label ID="Label2" runat="server" Font-Size="X-Large" Text="Weight  :-" CssClass="auto-style2"></asp:Label></div>
            <div class="col-md-3 text-left"><asp:TextBox ID="TextBox1" Required="" runat="server" CssClass="form-control"></asp:TextBox></div>
            <div class="col-md-4 text-left"><asp:Label ID="Label4" runat="server" Font-Size="Larger" Text="(Kg)" CssClass="auto-style3"></asp:Label></div>
           </div>

            <br />
            <div class="row">
            <div class="col-md-5 text-right"><asp:Label ID="Label3" runat="server" Font-Size="X-Large" Text="Height  :-" CssClass="auto-style2"></asp:Label></div>
            <div class="col-md-3 text-left"><asp:TextBox ID="TextBox2" Required="" runat="server" CssClass="form-control"></asp:TextBox></div>
            <div class="col-md-4 text-left"><asp:Label ID="Label5" runat="server" Font-Size="Larger" Text="(Centimetre)" CssClass="auto-style3"></asp:Label></div>
           </div>
            <br />
        ...
        <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
            Text="Calculate" CssClass="btn btn-warning" style="font-size: x-large" />
        <br />
        <br />
        <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <br />
        <asp:Button ID="Button2" CssClass="btn btn-warning" runat="server" onclick="Button2_Click" Text="Get Diet Plan" 
